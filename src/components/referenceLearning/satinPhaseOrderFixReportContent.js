export const SATIN_PHASE_ORDER_FIX_REPORT_MD = `# SATIN_PHASE_ORDER_FIX_REPORT_V1 — StitchPath AI
...
No se tocó UI_EXPORT_CENTER_CLEANUP_V1, exportación ni V5.1. Solo se movió el punto de llamada de SATIN dentro de applyProfessionalPipeline.
`;