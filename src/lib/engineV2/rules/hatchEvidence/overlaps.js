...
export const HATCH_OVERLAP_EVIDENCE_RULES = defineHatchEvidenceRules({
  ...
  rules: [
    ...
    { id: 'CONTOUR-LAST-001', sourceState: 'candidata', condition: 'Contorno que delimita uno o varios rellenos', candidateAction: 'Secuenciar el contorno después de todos sus rellenos dependientes.', confidence: 0.98, evidence: 'C8, C11 y C12' },
    ...
    { id: 'COLOR-GROUP-HEURISTIC-001', sourceState: 'candidata', condition: 'Optimización global de cambios de color', candidateAction: 'Tratar el agrupado por color como heurística; respetar primero el grafo inferior-superior-contorno.', confidence: 0.95, evidence: 'Secuencia de objetos 2 a 28' },
