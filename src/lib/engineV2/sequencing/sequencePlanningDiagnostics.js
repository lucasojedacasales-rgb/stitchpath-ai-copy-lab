...
export function createGlobalSequenceDiagnostic({ regions = [], threadedObjectMaterialization, technicalPlan, sequencePlan }) {
  ...
  return Object.freeze({
    ...
    ...(sequencePlan?.colorGroupHeuristicTrace ? {
      colorGroupHeuristicTrace: sequencePlan.colorGroupHeuristicTrace,
      colorGroupHeuristicActive: sequencePlan.colorGroupHeuristicTrace.active === true,
      colorGroupHeuristicEvaluatorInvoked: sequencePlan.colorGroupHeuristicTrace.evaluatorInvoked === true,
      colorGroupHeuristicApplied: sequencePlan.colorGroupHeuristicTrace.applied === true,
